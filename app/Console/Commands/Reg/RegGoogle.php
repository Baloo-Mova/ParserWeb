    ...
    public function handle() {
        ...
        while (true) {
            try {
                ...
                $request = $this->client->get('https://accounts.google.com/signup', [
                ]);
...
//dd($timeStmp."   ".$timeStmp2);
                ...
                $request = $this->client->request("POST", "https://accounts.google.com/RatePassword", [
                    'form_params' => [
                        'Passwd' => $password,
                        'Email' => $email,
                        'FirstName' => $f_name->name,
