    ...
    public function handle()
    {
        while (true) {
            ...
            $mutex->synchronized(function () {
                ...
                $this->task->google_ru_reserved = 1;
                $this->task->save();
            ...
            if (!isset($this->proxy)) {
                ...
                $this->task->google_ru_reserved = 0;
                $this->task->save();
            ...
            do {
                ...
                try {
                    while (true) {
                        $data = $this->client->get("https://www.google.ru/search?q=" . urlencode($this->task->task_query) . "&start=" . $i * 10, [
