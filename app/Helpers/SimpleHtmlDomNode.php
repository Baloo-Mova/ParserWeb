...
class SimpleHtmlDomNode
{
    ...
    function text()
    {
        ...
        $ret = '';
        // In rare cases, (always node type 1 or self::HDOM_TYPE_ELEMENT - observed for some span tags, and some p tags) $this->nodes is set to NULL.
