                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <div class="form-group has-feedback task_query_div">
                                ...
                                <textarea name="task_query" class="form-control" id="task_query" cols="30"
                                          rows="10"></textarea>
                            ...
                            <div class="send_directly_div">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <input class="form-control" placeholder="Тема" name="data[mail][subject]"
                                           id="subject"/>
                                </div>
                                <div class="form-group has-feedback">
                                    <label for="mails_text" class="control-label">Текст Сообщения E-mail</label>
                                    <textarea class="form-control" rows="5" name="data[mail][text]"
                                              id="mails_text"></textarea>
                                </div>
                                <hr>
                                <div class="form-group has-feedback">
                                    <label for="skype_text" class="control-label">Текст Сообщения Skype</label>
                                    <textarea class="form-control" rows="5" name="data[skype][text]"
                                              id="skype_text"></textarea>
                                </div>
                                <hr>
                                <div class="form-group has-feedback">
                                    <label for="vk_text" class="control-label">Текст Сообщения VK</label>
                                    <textarea class="form-control" rows="5" name="data[vk][text]"
                                              id="vk_text"></textarea>
                                </div>
                                <div class="form-group has-feedback">
                                    <label> Media</label>
                                    <input name="data[vk][media]" value="" class="form-control">
                                </div>
                                <hr>
                                <div class="form-group has-feedback">
                                    <label for="ok_text" class="control-label">Текст Сообщения OK</label>
                                    <textarea class="form-control" rows="5" name="data[ok][text]"
                                              id="ok_text"></textarea>
                                </div>
                                <hr>
                                <div class="form-group has-feedback">
                                    <label for="viber_text" class="control-label">Текст Сообщения Viber</label>
                                    <textarea class="form-control" rows="5" name="data[viber][text]" id="viber_text"
                                              maxlength="100"></textarea>
                                </div>
                                <div class="form-group has-feedback">
                                    <label for="whats_text" class="control-label">Текст Сообщения WhatsApp</label>
                                    <textarea class="form-control" rows="5" name="data[whatsapp][text]" id="whats_text"
                                              maxlength="100"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="box-footer">
                            <input type="submit" class="btn btn-primary btn-flat" value="Создать">
                        </div>
                    </div>
                </div>
            </form>
